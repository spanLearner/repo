...
export class QuizComponent implements OnInit {
  ...
  // }
   ...
   questions = [
    ...
    {
      question:
        "Who among the following holds his/her office during the pleasure of the president ?",
      optionA: "Attorney General",
      optionB: "CAG",
    ...
    {
      question:
        "Who amongst the following is considered to be the first law officer  ?",
    ...
    {
      question:
        "Who among the following shall have the right of audience in all courts in the territory of India in the performance of his duties ?",
    ...
    {
      question:
        "Who among the following has a right to speak and otherwise take part in the proceedings of the either hosue of the parliament and to eb a memebr of any parliamentary committee but is not entitled to vote ?",
      optionA: "Advocates General",
      optionB: "Attorney General ",
      optionC: " Additional Advocates General",
      optionD: " None of above",
    ...
    {
      question:
        "Under which article of the indian constituion is teh comptorller and auditor general of india appointed ?",
      optionA: "Article 146",
      optionB: "Article 147",
      optionC: "148",
      optionD: "149",
    ...
    {
      question:
        "The reports of the CAG and auditor general of india relating to the accounts fo the union are submitted first of all to which of the following ?",
    ...
    {
      question:
        "The office of the comptroller and auditor general of india was created  ?",
  ...
  
    {
      ...
      optionC:
        "He is disqualified for any further govenment office after retirement",
    ...
    {
      question:
        "The CAG of india can be removed from his office in like manner as ?",
  ...
  
    {
      ...
      optionA:
        "To audit and report on all expenditure fome the consolidated fund of india",
      optionB:
        " To audit and report on all expenditure from the contingency fund and public accounts",
      optionC:
    ...
    {
      question:
        "In india, other than ensuring that public funds are used efficiently and for the intended purpose, what is the importance of the office of the comptroller and auditor general ?",
      optionA:
        "CAG exercises exchequer control on behalf of teh parliament when the president of india declares national emergency/ financial emergency",
      optionB:
        "CAg reports on the execution of projects or programmes by the ministries are discussed by the public accouts committee",
      optionC:
    ...
    {
      question:
        "The ultimate responsibility of taking due action on the comments of the CAG vests with ?",
    ...
    {
      question:
        "Which article of the constitution prescribes the duties of CAG ?",
      optionA: "146",
      optionB: "149",
      optionC: "148",
      optionD: "147",
    ...
    {
      question:
        "Which of the following option is not correct ? <p> Public finance studies financial activities of the government. it consists of...</p>",
    ...
    {
      question:
        "The amendment to CAg duties, powers and condition of service act 1971 seprates accounts from audit and relieves the CAG of his responsibility in the matters of preparation of accounts. the amendments were made in the year ?",
      optionA: "1972",
      optionB: "1980",
      optionC: "1976",
      optionD: "1987",
